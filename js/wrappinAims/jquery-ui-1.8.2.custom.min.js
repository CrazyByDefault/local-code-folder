        ...
        A.extend(A.ui, {
            ...
            plugin: {
                add: function(C, B, E) {
                    C = A.ui[C].prototype;
                    for (var D in E) {
                        C.plugins[D] = C.plugins[D] || [];
                        C.plugins[D].push([B, E[D]]);
                    }
                },
                call: function(C, B, E) {
                    if ((B = C.plugins[B]) && C.element[0].parentNode) {
                        for (var D = 0; D < B.length; D++) {
                            C.options[B[D][0]] && B[D][1].apply(C.element, E);
                        }
                    }
                }
            },
            contains: function(C, B) {
                return document.compareDocumentPosition ? C.compareDocumentPosition(B) & 16 : C !== B && C.contains(B);
            },
            ...
            isOver: function(C, B, G, F, E, D) {
                return A.ui.isOverAxis(C, G, E) && A.ui.isOverAxis(B, F, D);
            },
            keyCode: {
                ALT: 18,
                BACKSPACE: 8,
...
(function(A) {
    ...
    A.widget = function(C, G, F) {
        ...
        A[E] = A[E] || {};
        A[E][C] = function(H, I) {
            arguments.length && this._createWidget(H, I);
        };
        G = new G;
        G.options = A.extend({}, G.options);
        A[E][C].prototype = A.extend(true, G, {
            namespace: E,
            widgetName: C,
            widgetEventPrefix: A[E][C].prototype.widgetEventPrefix || C,
            widgetBaseClass: D
        }, F);
    ...
    A.widget.bridge = function(C, D) {
        A.fn[C] = function(H) {
            ...
            if (G && H.substring(0, 1) === "_") {
                return E;
            }
            G ? this.each(function() {
                var J = A.data(this, C),
                    I = J && A.isFunction(J[H]) ? J[H].apply(J, F) : J;
                if (I !== J && I !== undefined) {
                    E = I;
                    return false;
                }
                ...
                if (I) {
                    ...
                    A.data(this, C, new D(H, this));
                }
            });
            return E;
        };
    };
    A.Widget = function(C, D) {
    ...
    A.widget("ui.mouse", {
        ...
        _mouseDown: function(C) {
            ...
            if (!C.originalEvent.mouseHandled) {
                ...
                var B = this,
                    E = C.which == 1,
                    D = typeof this.options.cancel == "string" ? A(C.target).parents().add(C.target).filter(this.options.cancel).length : false;
                if (!E || D || !this._mouseCapture(C)) {
                    return true;
                }
...
(function(E) {
    ...
    E.fn.position = function(G) {
        ...
        if (G.of.nodeType === 9) {
            ...
            if (G.of.scrollTo && G.of.document) {
                J = F.width();
                I = F.height();
                H = {
                    top: F.scrollTop(),
        ...
        E.each(["my", "at"], function() {
            var M = (G[this] || "").split(" ");
            if (M.length === 1) {
                M = A.test(M[0]) ? M.concat(["center"]) : D.test(M[0]) ? ["center"].concat(M) : ["center", "center"];
            }
        ...
        return this.each(function() {
            ...
            E.each(["left", "top"], function(R, Q) {
                E.ui.position[L[R]] && E.ui.position[L[R]][Q](O, {
                    targetWidth: J,
                    targetHeight: I,
                    elemWidth: N,
                    elemHeight: M,
        ...
        flip: {
            left: function(G, F) {
                if (F.at[0] !== "center") {
                    ...
                    var I = F.my[0] === "left" ? -F.elemWidth : F.my[0] === "right" ? F.elemWidth : 0,
                        H = -2 * F.offset[0];
            ...
            top: function(G, F) {
                if (F.at[1] !== "center") {
                    ...
                    var J = F.my[1] === "top" ? -F.elemHeight : F.my[1] === "bottom" ? F.elemHeight : 0,
                        I = F.at[1] === "top" ? F.targetHeight : -F.targetHeight,
                        H = -2 * F.offset[1];
    ...
    if (!E.offset.setOffset) {
        E.offset.setOffset = function(G, F) {
            if (/static/.test(E.curCSS(G, "position"))) {
                G.style.position = "relative";
            }
            var K = E(G),
                J = K.offset(),
                I = parseInt(E.curCSS(G, "top", true), 10) || 0,
                H = parseInt(E.curCSS(G, "left", true), 10) || 0;
            J = {
                top: F.top - J.top + I,
                left: F.left - J.left + H
            };
            "using" in F ? F.using.call(G, J) : K.css(J);
        };
        E.fn.offset = function(G) {
            var F = this[0];
...
(function(A) {
    A.widget("ui.draggable", A.ui.mouse, {
        ...
        _mouseDrag: function(C, B) {
            ...
            if (!B) {
                B = this._uiHash();
                if (this._trigger("drag", C, B) === false) {
                    this._mouseUp({});
                    return false;
                }
        ...
        _convertPositionTo: function(C, B) {
            ...
            return {
                top: B.top + this.offset.relative.top * C + this.offset.parent.top * C - (A.browser.safari && A.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : D ? 0 : E.scrollTop()) * C),
                left: B.left + this.offset.relative.left * C + this.offset.parent.left * C - (A.browser.safari && A.browser.version < 526 && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : D ? 0 : E.scrollLeft()) * C)
            };
        },
        _generatePosition: function(C) {
            ...
            if (this.originalPosition) {
                ...
                if (B.grid) {
                    D = this.originalPageY + Math.round((D - this.originalPageY) / B.grid[1]) * B.grid[1];
            ...
            return {
                top: D - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (A.browser.safari && A.browser.version < 526 && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : E ? 0 : G.scrollTop()),
                left: F - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (A.browser.safari && A.browser.version < 526 && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : E ? 0 : G.scrollLeft())
            };
        },
        _clear: function() {
    ...
    A.ui.plugin.add("draggable", "scroll", {
        ...
        drag: function(C) {
            ...
            if (B.scrollParent[0] != document && B.scrollParent[0].tagName != "HTML") {
                if (!E.axis || E.axis != "x") {
                    if (B.overflowOffset.top + B.scrollParent[0].offsetHeight - C.pageY < E.scrollSensitivity) {
                        B.scrollParent[0].scrollTop = D = B.scrollParent[0].scrollTop + E.scrollSpeed;
                    } else {
                        if (C.pageY - B.overflowOffset.top < E.scrollSensitivity) {
                            B.scrollParent[0].scrollTop = D = B.scrollParent[0].scrollTop - E.scrollSpeed;
                        }
                    }
                }
                if (!E.axis || E.axis != "y") {
                    if (B.overflowOffset.left + B.scrollParent[0].offsetWidth - C.pageX < E.scrollSensitivity) {
                        B.scrollParent[0].scrollLeft = D = B.scrollParent[0].scrollLeft + E.scrollSpeed;
                    } else {
                        if (C.pageX - B.overflowOffset.left < E.scrollSensitivity) {
                            B.scrollParent[0].scrollLeft = D = B.scrollParent[0].scrollLeft - E.scrollSpeed;
                        }
                    }
                }
                ...
                if (!E.axis || E.axis != "x") {
                    if (C.pageY - A(document).scrollTop() < E.scrollSensitivity) {
                        D = A(document).scrollTop(A(document).scrollTop() - E.scrollSpeed);
                    } else {
                ...
                if (!E.axis || E.axis != "y") {
                    if (C.pageX - A(document).scrollLeft() < E.scrollSensitivity) {
                        D = A(document).scrollLeft(A(document).scrollLeft() - E.scrollSpeed);
                    } else {
    ...
    A.ui.plugin.add("draggable", "snap", {
        ...
        drag: function(T, S) {
            for (var R = A(this).data("draggable"), P = R.options, Q = P.snapTolerance, O = S.offset.left, H = O + R.helperProportions.width, I = S.offset.top, G = I + R.helperProportions.height, N = R.snapElements.length - 1; N >= 0; N--) {
                var M = R.snapElements[N].left,
                    K = M + R.snapElements[N].width,
                    L = R.snapElements[N].top,
                    J = L + R.snapElements[N].height;
                if (M - Q < O && O < K + Q && L - Q < I && I < J + Q || M - Q < O && O < K + Q && L - Q < G && G < J + Q || M - Q < H && H < K + Q && L - Q < I && I < J + Q || M - Q < H && H < K + Q && L - Q < G && G < J + Q) {
                    if (P.snapMode != "inner") {
                        var F = Math.abs(L - G) <= Q,
                            E = Math.abs(J - I) <= Q,
                            D = Math.abs(M - H) <= Q,
                            C = Math.abs(K - O) <= Q;
                        if (F) {
                            S.position.top = R._convertPositionTo("relative", {
                        ...
                        if (D) {
                            S.position.left = R._convertPositionTo("relative", {
                                top: 0,
                    ...
                    if (P.snapMode != "outer") {
                        ...
                        if (E) {
                            S.position.top = R._convertPositionTo("relative", {
                                top: J - R.helperProportions.height,
                                left: 0
                            }).top - R.margins.top;
                        }
                        if (D) {
                    ...
                    if (!R.snapElements[N].snapping && (F || E || D || C || B)) {
                        R.options.snap.snap && R.options.snap.snap.call(R.element, T, A.extend(R._uiHash(), {
                            snapItem: R.snapElements[N].item
                        }));
                    }
                    R.snapElements[N].snapping = F || E || D || C || B;
                } else {
                    R.snapElements[N].snapping && R.options.snap.release && R.options.snap.release.call(R.element, T, A.extend(R._uiHash(), {
                        snapItem: R.snapElements[N].item
                    }));
...
(function(A) {
    A.widget("ui.droppable", {
        ...
        _create: function() {
            ...
            this.isover = 0;
            this.isout = 1;
            this.accept = A.isFunction(B) ? B : function(D) {
                return D.is(B);
            };
            this.proportions = {
        ...
        destroy: function() {
            for (var C = A.ui.ddmanager.droppables[this.options.scope], B = 0; B < C.length; B++) {
        ...
        _drop: function(C, B) {
            ...
            this.element.find(":data(droppable)").not(".ui-draggable-dragging").each(function() {
                ...
                if (F.options.greedy && !F.options.disabled && F.options.scope == E.options.scope && F.accept.call(F.element[0], E.currentItem || E.element) && A.ui.intersect(E, A.extend(F, {
    ...
    A.ui.intersect = function(L, K, J) {
        if (!K.offset) {
            return false;
        }
        var I = (L.positionAbs || L.position.absolute).left,
            G = I + L.helperProportions.width,
            H = (L.positionAbs || L.position.absolute).top,
            F = H + L.helperProportions.height,
            E = K.offset.left,
            C = E + K.proportions.width,
            D = K.offset.top,
            B = D + K.proportions.height;
        switch (J) {
            case "fit":
                return E < I && G < C && D < H && F < B;
            case "intersect":
                return E < I + L.helperProportions.width / 2 && G - L.helperProportions.width / 2 < C && D < H + L.helperProportions.height / 2 && F - L.helperProportions.height / 2 < B;
            case "pointer":
                return A.ui.isOver((L.positionAbs || L.position.absolute).top + (L.clickOffset || L.offset.click).top, (L.positionAbs || L.position.absolute).left + (L.clickOffset || L.offset.click).left, D, E, K.proportions.height, K.proportions.width);
            case "touch":
                return (H >= D && H <= B || F >= D && F <= B || H < D && F > B) && (I >= E && I <= C || G >= E && G <= C || I < E && G > C);
            default:
                return false;
        }
    };
    A.ui.ddmanager = {
        ...
        prepareOffsets: function(C, B) {
            var H = A.ui.ddmanager.droppables[C.options.scope] || [],
                G = B ? B.type : null,
                E = (C.currentItem || C.element).find(":data(droppable)").andSelf(),
                F = 0;
            C: for (; F < H.length; F++) {
                if (!(H[F].options.disabled || C && !H[F].accept.call(H[F].element[0], C.currentItem || C.element))) {
                    for (var D = 0; D < E.length; D++) {
                        if (E[D] == H[F].element[0]) {
...
(function(C) {
    C.widget("ui.resizable", C.ui.mouse, {
        ...
        _create: function() {
            ...
            this.handles = E.handles || (!C(".ui-resizable-handle", this.element).length ? "e,s,se" : {
                n: ".ui-resizable-n",
                e: ".ui-resizable-e",
                s: ".ui-resizable-s",
                w: ".ui-resizable-w",
            ...
            if (this.handles.constructor == String) {
                ...
                for (var H = 0; H < I.length; H++) {
                    var F = C.trim(I[H]),
                        G = C('<div class="ui-resizable-handle ' + ("ui-resizable-" + F) + '"></div>');
            ...
            this._renderAxis = function(M) {
                ...
                for (var L in this.handles) {
                    if (this.handles[L].constructor == String) {
                        this.handles[L] = C(this.handles[L], this.element).show();
                    }
                    if (this.elementIsWrapper && this.originalElement[0].nodeName.match(/textarea|input|select|button/i)) {
                        var K = C(this.handles[L], this.element),
                            J = 0;
        ...
        _mouseStart: function(D) {
            ...
            C.browser.opera && /relative/.test(G.css("position")) && G.css({
                position: "relative",
                top: "auto",
                left: "auto"
            });
            ...
            if (E.containment) {
                H += C(E.containment).scrollLeft() || 0;
        ...
        _mouseStop: function(D) {
            ...
            if (this._helper) {
                ...
                H = F && C.ui.hasScroll(H[0], "left") ? 0 : I.sizeDiff.height;
                F = {
                    width: I.size.width - (F ? 0 : I.sizeDiff.width),
                    height: I.size.height - H
                };
                H = parseInt(I.element.css("left"), 10) + (I.position.left - I.originalPosition.left) || null;
                var G = parseInt(I.element.css("top"), 10) + (I.position.top - I.originalPosition.top) || null;
                E.animate || this.element.css(C.extend(F, {
                    top: G,
                    left: H
                }));
        ...
        _updateRatio: function(D) {
            var E = this.position,
                ...
                F = this.axis;
            if (D.height) {
                D.width = G.height * this.aspectRatio;
            } else {
                if (D.width) {
                    D.height = G.width / this.aspectRatio;
                }
            }
            if (F == "sw") {
        ...
        _respectSize: function(L) {
            var M = this.options,
                K = this.axis,
                J = B(L.width) && M.maxWidth && M.maxWidth < L.width,
                H = B(L.height) && M.maxHeight && M.maxHeight < L.height,
                I = B(L.width) && M.minWidth && M.minWidth > L.width,
                G = B(L.height) && M.minHeight && M.minHeight > L.height;
            if (I) {
                L.width = M.minWidth;
            }
            if (G) {
                L.height = M.minHeight;
            }
            if (J) {
                L.width = M.maxWidth;
            }
            if (H) {
                L.height = M.maxHeight;
            }
            var F = this.originalPosition.left + this.originalSize.width,
                E = this.position.top + this.size.height,
                D = /sw|nw|w/.test(K);
            K = /nw|ne|n/.test(K);
            if (I && D) {
                L.left = F - M.minWidth;
            ...
            if ((M = !L.width && !L.height) && !L.left && L.top) {
                L.top = null;
            } else {
                if (M && !L.top && L.left) {
                    L.left = null;
        ...
        _proportionallyResize: function() {
            if (this._proportionallyResizeElements.length) {
                for (var D = this.helper || this.element, E = 0; E < this._proportionallyResizeElements.length; E++) {
                    var H = this._proportionallyResizeElements[E];
                    if (!this.borderDif) {
                        var G = [H.css("borderTopWidth"), H.css("borderRightWidth"), H.css("borderBottomWidth"), H.css("borderLeftWidth")],
                            F = [H.css("paddingTop"), H.css("paddingRight"), H.css("paddingBottom"), H.css("paddingLeft")];
                        this.borderDif = C.map(G, function(J, I) {
                            J = parseInt(J, 10) || 0;
                            I = parseInt(F[I], 10) || 0;
                            return J + I;
                        });
                    }
                    C.browser.msie && (C(D).is(":hidden") || C(D).parents(":hidden").length) || H.css({
    ...
    C.ui.plugin.add("resizable", "alsoResize", {
        ...
        resize: function() {
            var D = C(this).data("resizable"),
                ...
                F = {
                    height: D.size.height - I.height || 0,
                    width: D.size.width - I.width || 0,
                ...
                G = function(K, J) {
                    C(K).each(function() {
                        var M = C(this),
                            L = C(this).data("resizable-alsoresize"),
                            N = {};
                        C.each((J && J.length ? J : ["width", "height", "top", "left"]) || ["width", "height", "top", "left"], function(P, O) {
                            if ((P = (L[O] || 0) + (F[O] || 0)) && P >= 0) {
                                N[O] = P || null;
                            }
                        });
                        if (/relative/.test(M.css("position")) && C.browser.opera) {
            ...
            typeof E.alsoResize == "object" && !E.alsoResize.nodeType ? C.each(E.alsoResize, function(K, J) {
                G(K, J);
            }) : G(E.alsoResize);
        },
        stop: function() {
    ...
    C.ui.plugin.add("resizable", "animate", {
        stop: function(D) {
            var E = C(this).data("resizable"),
                ...
                H = G && C.ui.hasScroll(I[0], "left") ? 0 : E.sizeDiff.height;
            G = {
                width: E.size.width - (G ? 0 : E.sizeDiff.width),
                height: E.size.height - H
            };
            ...
            E.element.animate(C.extend(G, F && H ? {
                top: F,
                left: H
            } : {}), {
    ...
    C.ui.plugin.add("resizable", "containment", {
        start: function() {
            var D = C(this).data("resizable"),
                E = D.element,
                J = D.options.containment;
            if (E = J instanceof C ? J.get(0) : /parent/.test(J) ? E.parent().get(0) : J) {
                D.containerElement = C(E);
                if (/document/.test(J) || J == document) {
                    ...
                    var I = C(E),
                        G = [];
                    C(["Top", "Right", "Left", "Bottom"]).each(function(L, K) {
                        G[L] = A(I.css("padding" + K));
                    });
                    D.containerOffset = I.offset();
                    D.containerPosition = I.position();
                    D.containerSize = {
                        height: I.innerHeight() - G[3],
                        width: I.innerWidth() - G[1]
                    };
                    J = D.containerOffset;
                    var H = D.containerSize.height,
                        F = D.containerSize.width;
                    F = C.ui.hasScroll(E, "left") ? E.scrollWidth : F;
                    H = C.ui.hasScroll(E) ? E.scrollHeight : H;
                    D.parentData = {
                        element: E,
                        left: J.left,
                        top: J.top,
        ...
        resize: function(D) {
            ...
            var H = {
                ...
                F = E.containerElement;
            if (F[0] != document && /static/.test(F.css("position"))) {
                H = I;
            }
            if (G.left < (E._helper ? I.left : 0)) {
                E.size.width += E._helper ? E.position.left - I.left : E.position.left - H.left;
                if (D) {
                    E.size.height = E.size.width / J.aspectRatio;
                }
                E.position.left = J.helper ? I.left : 0;
            }
            if (G.top < (E._helper ? I.top : 0)) {
                E.size.height += E._helper ? E.position.top - I.top : E.position.top;
                if (D) {
            ...
            J = Math.abs((E._helper ? E.offset.left - H.left : E.offset.left - H.left) + E.sizeDiff.width);
            I = Math.abs((E._helper ? E.offset.top - H.top : E.offset.top - I.top) + E.sizeDiff.height);
            G = E.containerElement.get(0) == E.element.parent().get(0);
            H = /relative|absolute/.test(E.containerElement.css("position"));
            if (G && H) {
                J -= E.parentData.left;
            }
            ...
            if (I + E.size.height >= E.parentData.height) {
                E.size.height = E.parentData.height - I;
                if (D) {
        ...
        stop: function() {
            var D = C(this).data("resizable"),
                E = D.options,
                K = D.containerOffset,
                J = D.containerPosition,
                H = D.containerElement,
                I = C(D.helper),
                G = I.offset(),
                F = I.outerWidth() - D.sizeDiff.width;
            I = I.outerHeight() - D.sizeDiff.height;
            D._helper && !E.animate && /relative/.test(H.css("position")) && C(this).css({
                left: G.left - J.left - K.left,
                width: F,
                height: I
            });
            D._helper && !E.animate && /static/.test(H.css("position")) && C(this).css({
                left: G.left - J.left - K.left,
                width: F,
                height: I
            });
    ...
    C.ui.plugin.add("resizable", "grid", {
        resize: function() {
            ...
            if (/^(se|s|e)$/.test(H)) {
                D.size.width = I.width + F;
                D.size.height = I.height + E;
            } else {
                if (/^(ne)$/.test(H)) {
                    D.size.width = I.width + F;
                    D.size.height = I.height + E;
                    D.position.top = G.top - E;
                } else {
                    if (/^(sw)$/.test(H)) {
                        D.size.width = I.width + F;
                        D.size.height = I.height + E;
    ...
    A.widget("ui.selectable", A.ui.mouse, {
        ...
        _mouseDrag: function(I) {
            ...
            if (!this.options.disabled) {
                ...
                this.selectees.each(function() {
                    var J = A.data(this, "selectable-item");
                    if (!(!J || J.element == G.element[0])) {
                        var K = false;
                        if (H.tolerance == "touch") {
                            K = !(J.left > E || J.right < B || J.top > D || J.bottom < F);
                        } else {
                            if (H.tolerance == "fit") {
                                K = J.left > B && J.right < E && J.top > F && J.bottom < D;
                            }
                        }
                        if (K) {
                            if (J.selected) {
...
(function(A) {
    A.widget("ui.sortable", A.ui.mouse, {
        ...
        _mouseCapture: function(C, B) {
            ...
            if (A.data(C.target, "sortable-item") == E) {
                F = A(C.target);
            }
            if (!F) {
                return false;
        ...
        _mouseStart: function(C, B, E) {
            ...
            if (!E) {
                for (E = this.containers.length - 1; E >= 0; E--) {
                    this.containers[E]._trigger("activate", C, D._uiHash(this));
                }
            }
            if (A.ui.ddmanager) {
                A.ui.ddmanager.current = this;
        ...
        _mouseDrag: function(C) {
            ...
            if (this.options.scroll) {
                var B = this.options,
                    F = false;
                if (this.scrollParent[0] != document && this.scrollParent[0].tagName != "HTML") {
                    if (this.overflowOffset.top + this.scrollParent[0].offsetHeight - C.pageY < B.scrollSensitivity) {
                        this.scrollParent[0].scrollTop = F = this.scrollParent[0].scrollTop + B.scrollSpeed;
                    } else {
                        if (C.pageY - this.overflowOffset.top < B.scrollSensitivity) {
                            this.scrollParent[0].scrollTop = F = this.scrollParent[0].scrollTop - B.scrollSpeed;
                        }
                    }
                    if (this.overflowOffset.left + this.scrollParent[0].offsetWidth - C.pageX < B.scrollSensitivity) {
                        this.scrollParent[0].scrollLeft = F = this.scrollParent[0].scrollLeft + B.scrollSpeed;
                    } else {
                        if (C.pageX - this.overflowOffset.left < B.scrollSensitivity) {
                            this.scrollParent[0].scrollLeft = F = this.scrollParent[0].scrollLeft - B.scrollSpeed;
                        }
                    }
                } else {
            ...
            for (B = this.items.length - 1; B >= 0; B--) {
                ...
                if (D) {
                    if (E != this.currentItem[0] && this.placeholder[D == 1 ? "next" : "prev"]()[0] != E && !A.ui.contains(this.placeholder[0], E) && (this.options.type == "semi-dynamic" ? !A.ui.contains(this.element[0], E) : true)) {
        ...
        cancel: function() {
            ...
            if (this.dragging) {
                ...
                for (var B = this.containers.length - 1; B >= 0; B--) {
                    this.containers[B]._trigger("deactivate", null, C._uiHash(this));
                    if (this.containers[B].containerCache.over) {
                        this.containers[B]._trigger("out", null, C._uiHash(this));
        ...
        serialize: function(C) {
            ...
            A(B).each(function() {
                ...
                if (E) {
                    D.push((C.key || E[1] + "[]") + "=" + (C.key && C.expression ? E[1] : E[2]));
                }
            });
            return D.join("&");
        },
        ...
        _intersectsWith: function(L) {
            var K = this.positionAbs.left,
                J = K + this.helperProportions.width,
                I = this.positionAbs.top,
                H = I + this.helperProportions.height,
                G = L.left,
                F = G + L.width,
                E = L.top,
                C = E + L.height,
        ...
        _intersectsWithPointer: function(C) {
            var B = A.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, C.top, C.height);
        ...
        _intersectsWithSides: function(C) {
            var B = A.ui.isOverAxis(this.positionAbs.top + this.offset.click.top, C.top + C.height / 2, C.height);
        ...
        _getItemsAsjQuery: function(C) {
            ...
            if (G && C) {
                for (C = G.length - 1; C >= 0; C--) {
                    for (var F = A(G[C]), E = F.length - 1; E >= 0; E--) {
                        var D = A.data(F[E], "sortable");
                        if (D && D != this && !D.options.disabled) {
                            H.push([A.isFunction(D.options.items) ? D.options.items.call(D.element) : A(D.options.items, D.element).not(".ui-sortable-helper").not(".ui-sortable-placeholder"), D]);
                        }
                    }
                }
            }
        ...
        _removeCurrentsFromItems: function() {
            for (var C = this.currentItem.find(":data(sortable-item)"), B = 0; B < this.items.length; B++) {
                for (var D = 0; D < C.length; D++) {
                    C[D] == this.items[B].item[0] && this.items.splice(B, 1);
                }
            }
        },
        _refreshItems: function(C) {
            ...
            if (H) {
                for (var G = H.length - 1; G >= 0; G--) {
                    for (var F = A(H[G]), E = F.length - 1; E >= 0; E--) {
                        var D = A.data(F[E], "sortable");
                        if (D && D != this && !D.options.disabled) {
                            I.push([A.isFunction(D.options.items) ? D.options.items.call(D.element[0], C, {
                                item: this.currentItem
                            }) : A(D.options.items, D.element), D]);
        ...
        refreshPositions: function(C) {
            ...
            for (var B = this.items.length - 1; B >= 0; B--) {
                var E = this.items[B],
                    D = this.options.toleranceElement ? A(this.options.toleranceElement, E.item) : E.item;
                if (!C) {
            ...
            if (this.options.custom && this.options.custom.refreshContainers) {
                ...
                for (B = this.containers.length - 1; B >= 0; B--) {
                    D = this.containers[B].element.offset();
                ...
                E.placeholder = {
                    ...
                    update: function(G, F) {
                        if (!(D && !E.forcePlaceholderSize)) {
                            F.height() || F.height(B.currentItem.innerHeight() - parseInt(B.currentItem.css("paddingTop") || 0, 10) - parseInt(B.currentItem.css("paddingBottom") || 0, 10));
            ...
            if (B) {
                if (this.containers.length === 1) {
                    ...
                    if (this.currentContainer != this.containers[H]) {
                        B = 10000;
                        G = null;
                        for (var F = this.positionAbs[this.containers[H].floating ? "left" : "top"], E = this.items.length - 1; E >= 0; E--) {
                            if (A.ui.contains(this.containers[H].element[0], this.items[E].item[0])) {
                                var D = this.items[E][this.containers[H].floating ? "left" : "top"];
                                if (Math.abs(D - F) < B) {
                                    B = Math.abs(D - F);
                                    G = this.items[E];
                                }
        ...
        _createHelper: function(C) {
            ...
            if (C[0].style.width == "" || B.forceHelperSize) {
                C.width(this.currentItem.width());
            }
            if (C[0].style.height == "" || B.forceHelperSize) {
        ...
        _convertPositionTo: function(C, B) {
            ...
            var E = this.cssPosition == "absolute" && !(this.scrollParent[0] != document && A.ui.contains(this.scrollParent[0], this.offsetParent[0])) ? this.offsetParent : this.scrollParent,
                D = /(html|body)/i.test(E[0].tagName);
            return {
                top: B.top + this.offset.relative.top * C + this.offset.parent.top * C - (A.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : D ? 0 : E.scrollTop()) * C),
                left: B.left + this.offset.relative.left * C + this.offset.parent.left * C - (A.browser.safari && this.cssPosition == "fixed" ? 0 : (this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : D ? 0 : E.scrollLeft()) * C)
            };
        },
        _generatePosition: function(C) {
            var B = this.options,
            ...
            return {
                top: D - this.offset.click.top - this.offset.relative.top - this.offset.parent.top + (A.browser.safari && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollTop() : F ? 0 : G.scrollTop()),
                left: E - this.offset.click.left - this.offset.relative.left - this.offset.parent.left + (A.browser.safari && this.cssPosition == "fixed" ? 0 : this.cssPosition == "fixed" ? -this.scrollParent.scrollLeft() : F ? 0 : G.scrollLeft())
            };
        },
        _rearrange: function(C, B, G, F) {
            G ? G[0].appendChild(this.placeholder[0]) : B.item[0].parentNode.insertBefore(this.placeholder[0], this.direction == "down" ? B.item[0] : B.item[0].nextSibling);
            this.counter = this.counter ? ++this.counter : 1;
            var E = this,
                D = this.counter;
            window.setTimeout(function() {
                D == E.counter && E.refreshPositions(!F);
            }, 0);
        },
        _clear: function(C, B) {
            ...
            this.fromOutside && !B && E.push(function(F) {
            ...
            if (!A.ui.contains(this.element[0], this.currentItem[0])) {
                ...
                for (D = this.containers.length - 1; D >= 0; D--) {
                    if (A.ui.contains(this.containers[D].element[0], this.currentItem[0]) && !B) {
                        E.push(function(F) {
                            return function(G) {
...
(function(A) {
    A.widget("ui.accordion", {
        ...
        _create: function() {
            ...
            if (C.navigation) {
                var E = this.element.find("a").filter(C.navigationFilter);
                if (E.length) {
                    var D = E.closest(".ui-accordion-header");
                    this.active = D.length ? D : E.closest(".ui-accordion-content").prev();
                }
            }
            ...
            C.event && this.headers.bind(C.event + ".accordion", function(F) {
        ...
        _keydown: function(C) {
            ...
            if (!(this.options.disabled || C.altKey || C.ctrlKey)) {
                ...
                switch (C.keyCode) {
                    case B.RIGHT:
                    case B.DOWN:
                        D = this.headers[(E + 1) % F];
                        break;
                    case B.LEFT:
                    case B.UP:
                        D = this.headers[(E - 1 + F) % F];
                        break;
                    case B.SPACE:
                    case B.ENTER:
                        this._clickHandler({
        ...
        _clickHandler: function(C, B) {
            var G = this.options;
            if (!G.disabled) {
                if (C.target) {
                    C = A(C.currentTarget || B);
                    B = C[0] == this.active[0];
                    G.active = G.collapsible && B ? false : A(".ui-accordion-header", this.element).index(C);
                    if (!(this.running || !G.collapsible && B)) {
                        this.active.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").find(".ui-icon").removeClass(G.icons.headerSelected).addClass(G.icons.header);
                        if (!B) {
                            C.removeClass("ui-state-default ui-corner-all").addClass("ui-state-active ui-corner-top").find(".ui-icon").removeClass(G.icons.header).addClass(G.icons.headerSelected);
                        ...
                        D = {
                            options: G,
                            newHeader: B && G.collapsible ? A([]) : C,
                            oldHeader: this.active,
                            newContent: B && G.collapsible ? A([]) : F,
                            oldContent: E
                        };
                        G = this.headers.index(this.active[0]) > this.headers.index(C[0]);
                        this.active = B ? A([]) : C;
                        this._toggle(F, E, D, B, G);
                    }
                } else {
                    if (G.collapsible) {
                        this.active.removeClass("ui-state-active ui-corner-top").addClass("ui-state-default ui-corner-all").find(".ui-icon").removeClass(G.icons.headerSelected).addClass(G.icons.header);
        ...
        _toggle: function(K, J, I, G, F) {
            ...
            this.running = J.size() === 0 ? K.size() : J.size();
            if (H.animated) {
                I = {};
                I = H.collapsible && G ? {
                    toShow: A([]),
            ...
            K.prev().attr("aria-expanded", "true").attr("tabIndex", "0").focus();
        },
...
(function(A) {
            ...
            this.menu = A("<ul></ul>").addClass("ui-autocomplete").appendTo("body", C).mousedown(function() {
                ...
                focus: function(E, D) {
                    ...
                    false !== B._trigger("focus", null, {
                        item: D
                    }) && /^key/.test(E.originalEvent.type) && B.element.val(D.value);
                },
                selected: function(E, D) {
                    D = D.item.data("item.autocomplete");
        ...
        _initSource: function() {
            ...
            if (A.isArray(this.options.source)) {
                ...
                this.source = function(E, D) {
                    D(A.ui.autocomplete.filter(B, E.term));
                };
            } else {
    ...
    A.extend(A.ui.autocomplete, {
        ...
        filter: function(B, D) {
            var C = new RegExp(A.ui.autocomplete.escapeRegex(D), "i");
            return A.grep(B, function(E) {
...
(function(A) {
    A.widget("ui.menu", {
        ...
        activate: function(C, F) {
            this.deactivate();
            if (this.hasScroll()) {
                var E = F.offset().top - this.element.offset().top,
                    B = this.element.attr("scrollTop"),
                    D = this.element.height();
                if (E < 0) {
                    this.element.attr("scrollTop", B + E);
                } else {
                    E > D && this.element.attr("scrollTop", B + E - D + F.height());
                }
            }
        ...
        move: function(B, D, C) {
            if (this.active) {
                ...
                B.length ? this.activate(C, B) : this.activate(C, this.element.children(D));
            } else {
                ...
                if (!this.active || this.last()) {
                    ...
                    var E = this.active.offset().top,
                        ...
                        B = this.element.children("li").filter(function() {
                            var F = A(this).offset().top - E - D + A(this).height();
                            return F < 10 && F > -10;
                        });
...
(function(A) {
    var D, B = function(E) {
            A(":ui-button", E.target.form).each(function() {
                var F = A(this).data("button");
                setTimeout(function() {
                    F.refresh();
                }, 1);
            });
        ...
        C = function(E) {
            var H = E.name,
                ...
                F = A([]);
            if (H) {
                F = G ? A(G).find("[name='" + H + "']") : A("[name='" + H + "']", E.ownerDocument).filter(function() {
                    return !this.form;
                });
            }
            return F;
    ...
    A.widget("ui.button", {
        ...
        _create: function() {
            ...
            var E = this,
                ...
                F = "ui-state-hover" + (!G ? " ui-state-active" : "");
            if (H.label === null) {
            ...
            this.buttonElement.addClass("ui-button ui-widget ui-state-default ui-corner-all").attr("role", "button").bind("mouseenter.button", function() {
                ...
                H.disabled || A(this).removeClass(F);
            ...
            if (this.type === "checkbox") {
                ...
                if (this.type === "radio") {
                    ...
                    this.buttonElement.bind("mousedown.button", function() {
                        ...
                        if (I.keyCode == A.ui.keyCode.SPACE || I.keyCode == A.ui.keyCode.ENTER) {
                            A(this).addClass("ui-state-active");
                        }
                    ...
                    this.buttonElement.is("a") && this.buttonElement.keyup(function(I) {
                        I.keyCode === A.ui.keyCode.SPACE && A(this).click();
                    });
                }
            }
        ...
        _resetButton: function() {
            if (this.type === "input") {
                ...
                var E = this.buttonElement.removeClass("ui-button-icons-only ui-button-icon-only ui-button-text-icons ui-button-text-icon ui-button-text-only"),
                    H = A("<span></span>").addClass("ui-button-text").html(this.options.label).appendTo(E.empty()).text(),
                    G = this.options.icons,
                    F = G.primary && G.secondary;
                if (G.primary || G.secondary) {
                    E.addClass("ui-button-text-icon" + (F ? "s" : ""));
                    ...
                    if (!this.options.text) {
                        E.addClass(F ? "ui-button-icons-only" : "ui-button-icon-only").removeClass("ui-button-text-icons ui-button-text-icon");
    ...
    A.widget("ui.buttonset", {
        ...
        _setOption: function(E, F) {
            E === "disabled" && this.buttons.button("option", E, F);
            A.Widget.prototype._setOption.apply(this, arguments);
        },
        refresh: function() {
...
(function(A) {
    A.widget("ui.dialog", {
        ...
        _create: function() {
            ...
            var C = this,
                B = C.options,
                H = B.title || C.originalTitle || "&#160;",
                G = A.ui.dialog.getTitleId(C.element),
                E = (C.uiDialog = A("<div></div>")).appendTo(document.body).hide().addClass("ui-dialog ui-widget ui-widget-content ui-corner-all " + B.dialogClass).css({
                    zIndex: B.zIndex
                }).attr("tabIndex", -1).css("outline", 0).keydown(function(I) {
                    if (B.closeOnEscape && I.keyCode && I.keyCode === A.ui.keyCode.ESCAPE) {
                        C.close(I);
                        I.preventDefault();
                    }
                }).attr({
            ...
            var F = (C.uiDialogTitlebar = A("<div></div>")).addClass("ui-dialog-titlebar ui-widget-header ui-corner-all ui-helper-clearfix").prependTo(E),
                D = A('<a href="#"></a>').addClass("ui-dialog-titlebar-close ui-corner-all").attr("role", "button").hover(function() {
            ...
            (C.uiDialogTitlebarCloseText = A("<span></span>")).addClass("ui-icon ui-icon-closethick").text(B.closeText).appendTo(D);
            A("<span></span>").addClass("ui-dialog-title").attr("id", G).html(H).prependTo(F);
            if (A.isFunction(B.beforeclose) && !A.isFunction(B.beforeClose)) {
                B.beforeClose = B.beforeclose;
            }
            F.find("*").add(F).disableSelection();
            B.draggable && A.fn.draggable && C._makeDraggable();
            B.resizable && A.fn.resizable && C._makeResizable();
            C._createButtons(B.buttons);
            C._isOpen = false;
        ...
        destroy: function() {
            ...
            B.uiDialog.hide();
            B.element.unbind(".dialog").removeData("dialog").removeClass("ui-dialog-content ui-widget-content").hide().appendTo("body");
            B.uiDialog.remove();
            B.originalTitle && B.element.attr("title", B.originalTitle);
            return B;
        },
        widget: function() {
        ...
        close: function(C) {
            var B = this,
                D;
            if (false !== B._trigger("beforeClose", C)) {
                B.overlay && B.overlay.destroy();
                ...
                if (B.options.modal) {
                    ...
                    A(".ui-dialog").each(function() {
                        if (this !== B.uiDialog[0]) {
                            D = Math.max(D, A(this).css("z-index"));
                        }
                    });
                    A.ui.dialog.maxZ = D;
                }
        ...
        moveToTop: function(C, B) {
            var E = this,
                D = E.options;
            if (D.modal && !C || !D.stack && !D.modal) {
                return E._trigger("focus", B);
            }
            if (D.zIndex > A.ui.dialog.maxZ) {
                A.ui.dialog.maxZ = D.zIndex;
            }
            if (E.overlay) {
                A.ui.dialog.maxZ += 1;
        ...
        open: function() {
            if (!this._isOpen) {
                var C = this,
                    B = C.options,
                    D = C.uiDialog;
                C.overlay = B.modal ? new A.ui.dialog.overlay(C) : null;
                D.next().length && D.appendTo("body");
                C._size();
                C._position(B.position);
                D.show(B.show);
                C.moveToTop(true);
                B.modal && D.bind("keypress.ui-dialog", function(G) {
        ...
        _createButtons: function(C) {
            ...
            if (E) {
                A.each(C, function(F, G) {
                    F = A('<button type="button"></button>').text(F).click(function() {
        ...
        _makeDraggable: function() {
            ...
            B.uiDialog.draggable({
                ...
                start: function(H, G) {
                    D = F.height === "auto" ? "auto" : A(this).height();
                    A(this).height(A(this).height()).addClass("ui-dialog-dragging");
                    B._trigger("dragStart", H, C(G));
                },
                drag: function(H, G) {
                    B._trigger("drag", H, C(G));
                },
                stop: function(H, G) {
                    F.position = [G.position.left - E.scrollLeft(), G.position.top - E.scrollTop()];
                    A(this).removeClass("ui-dialog-dragging").height(D);
                    B._trigger("dragStop", H, C(G));
                    A.ui.dialog.overlay.resize();
                }
            });
        },
        _makeResizable: function(C) {
            ...
            F.uiDialog.resizable({
                ...
                start: function(H, G) {
                    ...
                    F._trigger("resizeStart", H, B(G));
                },
                resize: function(H, G) {
                    F._trigger("resize", H, B(G));
                },
                stop: function(H, G) {
                    A(this).removeClass("ui-dialog-resizing");
                    E.height = A(this).height();
                    E.width = A(this).width();
                    F._trigger("resizeStop", H, B(G));
                    A.ui.dialog.overlay.resize();
                }
        ...
        _position: function(C) {
            ...
            this.uiDialog.css({
                ...
                collision: "fit",
                using: function(F) {
                    var E = A(this).css(F).offset().top;
                    E < 0 && A(this).css("top", F.top - E);
                }
            });
        ...
        _setOption: function(C, B) {
            ...
            switch (C) {
                ...
                case "closeText":
                    ...
                    break;
                case "dialogClass":
                    F.removeClass(G.options.dialogClass).addClass("ui-dialog ui-widget ui-widget-content ui-corner-all " + B);
                    break;
                case "disabled":
                    B ? F.addClass("ui-dialog-disabled") : F.removeClass("ui-dialog-disabled");
                    break;
                case "draggable":
                    B ? G._makeDraggable() : F.draggable("destroy");
                    break;
                case "height":
                    E = true;
                    break;
                case "maxHeight":
                    D && F.resizable("option", "maxHeight", B);
                    E = true;
                    break;
                case "maxWidth":
                    D && F.resizable("option", "maxWidth", B);
                    E = true;
                    break;
                case "minHeight":
                    D && F.resizable("option", "minHeight", B);
                    E = true;
                    break;
                case "minWidth":
                    D && F.resizable("option", "minWidth", B);
                    E = true;
                    break;
                case "position":
                    G._position(B);
                    break;
                case "resizable":
                    D && !B && F.resizable("destroy");
                    D && typeof B === "string" && F.resizable("option", "handles", B);
                    !D && B !== false && G._makeResizable(B);
                    break;
                case "title":
        ...
        _size: function() {
            ...
            this.element.css(C.height === "auto" ? {
                minHeight: Math.max(C.minHeight - B, 0),
                height: "auto"
            } : {
                minHeight: 0,
                height: Math.max(C.height - B, 0)
            }).show();
    ...
    A.extend(A.ui.dialog.overlay, {
        ...
        oldInstances: [],
        maxZ: 0,
        events: A.map("focus,mousedown,mouseup,keydown,keypress,click".split(","), function(B) {
            return B + ".dialog-overlay";
        }).join(" "),
        create: function(C) {
            if (this.instances.length === 0) {
                setTimeout(function() {
                    A.ui.dialog.overlay.instances.length && A(document).bind(A.ui.dialog.overlay.events, function(D) {
                        return A(D.target).zIndex() >= A.ui.dialog.overlay.maxZ;
                    });
                }, 1);
                A(document).bind("keydown.dialog-overlay", function(D) {
                    if (C.options.closeOnEscape && D.keyCode && D.keyCode === A.ui.keyCode.ESCAPE) {
                        C.close(D);
                        D.preventDefault();
                    }
                });
        ...
        height: function() {
            ...
            if (A.browser.msie && A.browser.version < 7) {
                ...
                return C < B ? A(window).height() + "px" : C + "px";
            } else {
        ...
        width: function() {
            ...
            if (A.browser.msie && A.browser.version < 7) {
                ...
                return C < B ? A(window).width() + "px" : C + "px";
            } else {
    ...
    A.widget("ui.slider", A.ui.mouse, {
        ...
        _create: function() {
            ...
            if (B.values && B.values.length) {
                for (; A(".ui-slider-handle", this.element).length < B.values.length;) {
            ...
            this.handles.keydown(function(I) {
                var H = true,
                    G = A(this).data("index.ui-slider-handle"),
                    F, E, D;
                if (!C.options.disabled) {
                    ...
                    D = C.options.step;
                    F = C.options.values && C.options.values.length ? (E = C.values(G)) : (E = C.value());
                    switch (I.keyCode) {
                        case A.ui.keyCode.HOME:
                            E = C._valueMin();
                            break;
                        case A.ui.keyCode.END:
                            ...
                            break;
                        case A.ui.keyCode.PAGE_UP:
                            E = C._trimAlignValue(F + (C._valueMax() - C._valueMin()) / 5);
                            break;
                        case A.ui.keyCode.PAGE_DOWN:
                            E = C._trimAlignValue(F - (C._valueMax() - C._valueMin()) / 5);
                            break;
        ...
        _mouseCapture: function(C) {
            ...
            H = this._normValueFromMouse(I);
            G = this._valueMax() - this._valueMin() + 1;
            E = this;
            this.handles.each(function(K) {
                var J = Math.abs(H - E.values(K));
                if (G > J) {
                    G = J;
                    F = A(this);
                    D = K;
            ...
            this._clickOffset = !A(C.target).parents().andSelf().is(".ui-slider-handle") ? {
                ...
                left: C.pageX - B.left - F.width() / 2,
                top: C.pageY - B.top - F.height() / 2 - (parseInt(F.css("borderTopWidth"), 10) || 0) - (parseInt(F.css("borderBottomWidth"), 10) || 0) + (parseInt(F.css("marginTop"), 10) || 0)
            };
            H = this._normValueFromMouse(I);
            this._slide(C, D, H);
        ...
        _start: function(C, B) {
            ...
            if (this.options.values && this.options.values.length) {
                D.value = this.values(B);
                D.values = this.values();
            }
            return this._trigger("start", C, D);
        },
        _slide: function(C, B, E) {
            var D;
            if (this.options.values && this.options.values.length) {
                D = this.values(B ? 0 : 1);
                if (this.options.values.length === 2 && this.options.range === true && (B === 0 && E > D || B === 1 && E < D)) {
                    E = D;
                }
                if (E !== this.values(B)) {
                    D = this.values();
        ...
        values: function(C, B) {
            ...
            if (arguments.length > 1) {
                this.options.values[C] = this._trimAlignValue(B);
                this._refreshValue();
                this._change(null, C);
            }
            if (arguments.length) {
        ...
        _values: function(C) {
            var B, D;
            if (arguments.length) {
                B = this.options.values[C];
                return B = this._trimAlignValue(B);
            } else {
                B = this.options.values.slice();
                for (D = 0; D < B.length; D += 1) {
                    B[D] = this._trimAlignValue(B[D]);
                }
                return B;
            }
        },
        ...
        _refreshValue: function() {
            var K = this.options.range,
                J = this.options,
                I = this,
                H = !this._animateOff ? J.animate : false,
                G, F = {},
                E, D, C, B;
            if (this.options.values && this.options.values.length) {
                this.handles.each(function(L) {
                    G = (I.values(L) - I._valueMin()) / (I._valueMax() - I._valueMin()) * 100;
                    F[I.orientation === "horizontal" ? "left" : "bottom"] = G + "%";
                    A(this).stop(1, 1)[H ? "animate" : "css"](F, J.animate);
                    if (I.options.range === true) {
                        if (I.orientation === "horizontal") {
                            if (L === 0) {
                                I.range.stop(1, 1)[H ? "animate" : "css"]({
                                    left: G + "%"
                                }, J.animate);
                            }
                            if (L === 1) {
                                I.range[H ? "animate" : "css"]({
                                    width: G - E + "%"
                                }, {
                                    queue: false,
                                    duration: J.animate
                ...
                G = B !== C ? (D - C) / (B - C) * 100 : 0;
                F[I.orientation === "horizontal" ? "left" : "bottom"] = G + "%";
                this.handle.stop(1, 1)[H ? "animate" : "css"](F, J.animate);
...
(function(E) {
    ...
    E.widget("ui.tabs", {
        ...
        _setOption: function(G, F) {
            if (G == "selected") {
                this.options.collapsible && F == this.options.selected || this.select(F);
            } else {
                this.options[G] = F;
                this._tabify();
            }
        ...
        _cookie: function() {
            var F = this.cookie || (this.cookie = this.options.cookie.name || "ui-tabs-" + B());
            return E.cookie.apply(null, [F].concat(E.makeArray(arguments)));
        },
        _ui: function(G, F) {
            return {
                tab: G,
        ...
        _tabify: function(O) {
            function N(R, S) {
                ...
                !E.support.opacity && S.opacity && R[0].style.removeAttribute("filter");
            }
            ...
            this.anchors.each(function(T, U) {
                var S = E(U).attr("href"),
                    R = S.split("#")[0],
                    V;
                if (R && (R === location.toString().split("#")[0] || (V = E("base")[0]) && R === V.href)) {
                    S = U.hash;
                    U.href = S;
                }
                if (M.test(S)) {
                    Q.panels = Q.panels.add(Q._sanitizeSelector(S));
                } else {
                    if (S != "#") {
                        E.data(U, "href.tabs", S);
                        E.data(U, "load.tabs", S.replace(/#.*$/, ""));
                        S = Q._tabId(U);
                        U.href = "#" + S;
                        U = E("#" + S);
                        if (!U.length) {
                            U = E(P.panelTemplate).attr("id", S).addClass("ui-tabs-panel ui-widget-content ui-corner-bottom").insertAfter(Q.panels[T - 1] || Q.list);
                            U.data("destroy.tabs", true);
                        }
                        Q.panels = Q.panels.add(U);
                    } else {
                        P.disabled.push(T);
                    }
                }
            ...
            if (O) {
                ...
                if (P.selected === undefined) {
                    location.hash && this.anchors.each(function(R, S) {
                        if (S.hash == location.hash) {
                            P.selected = R;
                            return false;
                        }
                    });
                    if (typeof P.selected != "number" && P.cookie) {
                        P.selected = parseInt(Q._cookie(), 10);
                    }
                    if (typeof P.selected != "number" && this.lis.filter(".ui-tabs-selected").length) {
                        P.selected = this.lis.index(this.lis.filter(".ui-tabs-selected"));
                    }
                ...
                P.disabled = E.unique(P.disabled.concat(E.map(this.lis.filter(".ui-state-disabled"), function(R) {
                    return Q.lis.index(R);
                }))).sort();
                E.inArray(P.selected, P.disabled) != -1 && P.disabled.splice(E.inArray(P.selected, P.disabled), 1);
                this.panels.addClass("ui-tabs-hide");
                this.lis.removeClass("ui-tabs-selected ui-state-active");
                if (P.selected >= 0 && this.anchors.length) {
                    this.panels.eq(P.selected).removeClass("ui-tabs-hide");
                    this.lis.eq(P.selected).addClass("ui-tabs-selected ui-state-active");
                    Q.element.queue("tabs", function() {
                        Q._trigger("show", null, Q._ui(Q.anchors[P.selected], Q.panels[P.selected]));
                    });
            ...
            O = 0;
            for (var L; L = this.lis[O]; O++) {
                E(L)[E.inArray(O, P.disabled) != -1 && !E(L).hasClass("ui-tabs-selected") ? "addClass" : "removeClass"]("ui-state-disabled");
            }
            P.cache === false && this.anchors.removeData("cache.tabs");
            this.lis.add(this.anchors).unbind(".tabs");
            if (P.event != "mouseover") {
                var K = function(R, S) {
                        S.is(":not(.ui-state-disabled)") && S.addClass("ui-state-" + R);
                    },
                    I = function(R, S) {
                        S.removeClass("ui-state-" + R);
                    };
                ...
                this.anchors.bind("focus.tabs", function() {
                    K("focus", E(this).closest("li"));
                });
                this.anchors.bind("blur.tabs", function() {
                    I("focus", E(this).closest("li"));
                });
            }
            var J, H;
            if (P.fx) {
            ...
            var G = H ? function(R, S) {
                    E(R).closest("li").addClass("ui-tabs-selected ui-state-active");
                    S.hide().removeClass("ui-tabs-hide").animate(H, H.duration || "normal", function() {
                        N(S, H);
                        Q._trigger("show", null, Q._ui(R, S[0]));
                    });
                } : function(R, S) {
                    E(R).closest("li").addClass("ui-tabs-selected ui-state-active");
                ...
                F = J ? function(R, S) {
                    S.animate(J, J.duration || "normal", function() {
            ...
            this.anchors.bind(P.event + ".tabs", function() {
                var T = this,
                    U = E(this).closest("li"),
                    S = Q.panels.filter(":not(.ui-tabs-hide)"),
                    R = E(Q._sanitizeSelector(this.hash));
                if (U.hasClass("ui-tabs-selected") && !P.collapsible || U.hasClass("ui-state-disabled") || U.hasClass("ui-state-processing") || Q._trigger("select", null, Q._ui(this, R[0])) === false) {
                    this.blur();
                    return false;
                }
                P.selected = Q.anchors.index(this);
                Q.abort();
                if (P.collapsible) {
                    if (U.hasClass("ui-tabs-selected")) {
                        P.selected = -1;
                        P.cookie && Q._cookie(P.selected, P.cookie);
                        Q.element.queue("tabs", function() {
                            F(T, S);
                        }).dequeue("tabs");
                        this.blur();
                ...
                P.cookie && Q._cookie(P.selected, P.cookie);
                if (R.length) {
                    S.length && Q.element.queue("tabs", function() {
                        F(T, S);
                    });
                    Q.element.queue("tabs", function() {
                        G(T, R);
        ...
        destroy: function() {
            ...
            this.anchors.each(function() {
                var H = E.data(this, "href.tabs");
                if (H) {
                    this.href = H;
                }
                var G = E(this).unbind(".tabs");
                E.each(["href", "load", "cache"], function(I, J) {
                    G.removeData(J + ".tabs");
                });
            });
        ...
        add: function(K, J, G) {
            ...
            var F = this,
                I = this.options;
            J = E(I.tabTemplate.replace(/#\{href\}/g, K).replace(/#\{label\}/g, J));
            K = !K.indexOf("#") ? K.replace("#", "") : this._tabId(E("a", J)[0]);
            J.addClass("ui-state-default ui-corner-top").data("destroy.tabs", true);
            var H = E("#" + K);
            H.length || (H = E(I.panelTemplate).attr("id", K).data("destroy.tabs", true));
            ...
            if (G >= this.lis.length) {
                ...
                J.insertBefore(this.lis[G]);
                H.insertBefore(this.panels[G]);
            }
            I.disabled = E.map(I.disabled, function(L) {
                return L >= G ? ++L : L;
            });
            this._tabify();
        ...
        remove: function(I) {
            var H = this.options,
                G = this.lis.eq(I).remove(),
                F = this.panels.eq(I).remove();
            if (G.hasClass("ui-tabs-selected") && this.anchors.length > 1) {
                this.select(I + (I + 1 < this.anchors.length ? 1 : -1));
            }
            H.disabled = E.map(E.grep(H.disabled, function(J) {
                return J != I;
            }), function(J) {
                return J >= I ? --J : J;
            });
            this._tabify();
            this._trigger("remove", null, this._ui(G.find("a")[0], F[0]));
            return this;
        },
        enable: function(G) {
            var F = this.options;
            if (E.inArray(G, F.disabled) != -1) {
                this.lis.eq(G).removeClass("ui-state-disabled");
                F.disabled = E.grep(F.disabled, function(H) {
                    return H != G;
                });
        ...
        load: function(K) {
            var J = this,
                G = this.options,
                F = this.anchors.eq(K)[0],
                I = E.data(F, "load.tabs");
            this.abort();
            if (!I || this.element.queue("tabs").length !== 0 && E.data(F, "cache.tabs")) {
                ...
                this.xhr = E.ajax(E.extend({}, G.ajaxOptions, {
                    url: I,
                    success: function(M, N) {
                        E(J._sanitizeSelector(F.hash)).html(M);
                        J._cleanup();
                        G.cache && E.data(F, "cache.tabs", true);
                        J._trigger("load", null, J._ui(J.anchors[K], J.panels[K]));
                        try {
                            G.ajaxOptions.success(M, N);
                        } catch (L) {}
                    },
                    error: function(M, N) {
                        J._cleanup();
    ...
    E.extend(E.ui.tabs.prototype, {
        ...
        rotate: function(J, I) {
            var G = this,
                F = this.options,
                H = G._rotate || (G._rotate = function(K) {
                    clearTimeout(G.rotation);
                    G.rotation = setTimeout(function() {
                        var L = F.selected;
                        G.select(++L < G.anchors.length ? L : 0);
                    }, J);
                    K && K.stopPropagation();
                });
            I = G._unrotate || (G._unrotate = !I ? function(K) {
                K.clientX && G.rotate(null);
            } : function() {
                t = F.selected;
                H();
            });
            if (J) {
                ...
                this.anchors.bind(F.event + ".tabs", I);
                H();
            } else {
                clearTimeout(G.rotation);
                this.element.unbind("tabsshow", H);
                this.anchors.unbind(F.event + ".tabs", I);
                delete this._rotate;
...
jQuery.effects || function(I) {
    ...
    function B(M, L) {
        ...
        do {
            K = I.curCSS(M, L);
            if (K != "" && K != "transparent" || I.nodeName(M, "body")) {
                break;
            }
            L = "backgroundColor";
    ...
    function D(M) {
        ...
        for (L in M) {
            K = M[L];
            if (K == null || I.isFunction(K) || L in A || /scrollbar/.test(L) || !/color/i.test(L) && isNaN(parseFloat(K))) {
                delete M[L];
            }
        }
        return M;
    ...
    function H(N, L, K, M) {
        ...
        if (typeof L == "number" || I.fx.speeds[L]) {
            M = K;
            K = L;
            L = {};
        }
    ...
    I.effects = {};
    I.each(["backgroundColor", "borderBottomColor", "borderLeftColor", "borderRightColor", "borderTopColor", "color", "outlineColor"], function(L, K) {
        I.fx.step[K] = function(M) {
            if (!M.colorInit) {
                M.start = B(M.elem, K);
                M.end = G(M.end);
                M.colorInit = true;
    ...
    I.effects.animateClass = function(N, L, K, M) {
        if (I.isFunction(K)) {
            M = K;
            K = null;
        }
        return this.each(function() {
            var S = I(this),
                Q = S.attr("style") || " ",
                P = D(E.call(this)),
                R, O = S.attr("className");
            I.each(C, function(T, U) {
                N[U] && S[U + "Class"](N[U]);
            });
            R = D(E.call(this));
            S.attr("className", O);
            S.animate(J(P, R), L, K, function() {
                I.each(C, function(T, U) {
                    N[U] && S[U + "Class"](N[U]);
                });
    ...
    I.fn.extend({
        ...
        addClass: function(N, L, K, M) {
            return L ? I.effects.animateClass.apply(this, [{
                add: N
        ...
        toggleClass: function(O, L, K, N, M) {
            return typeof L == "boolean" || L === undefined ? K ? I.effects.animateClass.apply(this, [L ? {
                add: O
            } : {
                remove: O
            }, K, N, M]) : this._toggleClass(O, L) : I.effects.animateClass.apply(this, [{
                toggle: O
            }, L, K, N]);
        },
        switchClass: function(O, L, K, N, M) {
    ...
    I.extend(I.effects, {
        ...
        save: function(M, L) {
            for (var K = 0; K < L.length; K++) {
                L[K] !== null && M.data("ec.storage." + L[K], M[0].style[L[K]]);
            }
        },
        restore: function(M, L) {
            for (var K = 0; K < L.length; K++) {
                L[K] !== null && M.css(L[K], M.data("ec.storage." + L[K]));
            }
        },
        ...
        createWrapper: function(M) {
            ...
            var L = {
                ...
                K = I("<div></div>").addClass("ui-effects-wrapper").css({
                    fontSize: "100%",
            ...
            if (M.css("position") == "static") {
                ...
                I.each(["top", "left", "bottom", "right"], function(O, N) {
                    L[N] = M.css(N);
                    if (isNaN(parseInt(L[N], 10))) {
                        L[N] = "auto";
                    }
                });
                M.css({
        ...
        setTransition: function(N, L, K, M) {
            M = M || {};
            I.each(L, function(P, O) {
                unit = N.cssUnit(O);
                if (unit[0] > 0) {
                    M[O] = unit[0] * K + unit[1];
                }
    ...
    I.fn.extend({
        ...
        _show: I.fn.show,
        show: function(L) {
            if (!L || typeof L == "number" || I.fx.speeds[L]) {
        ...
        toggle: function(L) {
            if (!L || typeof L == "number" || I.fx.speeds[L] || typeof L == "boolean" || I.isFunction(L)) {
    ...
    I.extend(I.easing, {
        def: "easeOutQuad",
        swing: function(O, L, K, N, M) {
            return I.easing[I.easing.def](O, L, K, N, M);
        },
        easeInQuad: function(O, L, K, N, M) {
            return N * (L /= M) * L + K;
        },
        easeOutQuad: function(O, L, K, N, M) {
            return -N * (L /= M) * (L - 2) + K;
        },
        easeInOutQuad: function(O, L, K, N, M) {
            if ((L /= M / 2) < 1) {
                return N / 2 * L * L + K;
            }
            return -N / 2 * (--L * (L - 2) - 1) + K;
        },
        easeInCubic: function(O, L, K, N, M) {
            return N * (L /= M) * L * L + K;
        },
        easeOutCubic: function(O, L, K, N, M) {
            return N * ((L = L / M - 1) * L * L + 1) + K;
        },
        easeInOutCubic: function(O, L, K, N, M) {
            if ((L /= M / 2) < 1) {
                return N / 2 * L * L * L + K;
            }
            return N / 2 * ((L -= 2) * L * L + 2) + K;
        },
        easeInQuart: function(O, L, K, N, M) {
            return N * (L /= M) * L * L * L + K;
        },
        easeOutQuart: function(O, L, K, N, M) {
            return -N * ((L = L / M - 1) * L * L * L - 1) + K;
        },
        easeInOutQuart: function(O, L, K, N, M) {
            if ((L /= M / 2) < 1) {
                return N / 2 * L * L * L * L + K;
            }
            return -N / 2 * ((L -= 2) * L * L * L - 2) + K;
        },
        easeInQuint: function(O, L, K, N, M) {
            return N * (L /= M) * L * L * L * L + K;
        },
        easeOutQuint: function(O, L, K, N, M) {
            return N * ((L = L / M - 1) * L * L * L * L + 1) + K;
        },
        easeInOutQuint: function(O, L, K, N, M) {
            if ((L /= M / 2) < 1) {
                return N / 2 * L * L * L * L * L + K;
            }
            return N / 2 * ((L -= 2) * L * L * L * L + 2) + K;
        },
        easeInSine: function(O, L, K, N, M) {
            return -N * Math.cos(L / M * (Math.PI / 2)) + N + K;
        },
        easeOutSine: function(O, L, K, N, M) {
            return N * Math.sin(L / M * (Math.PI / 2)) + K;
        },
        easeInOutSine: function(O, L, K, N, M) {
            return -N / 2 * (Math.cos(Math.PI * L / M) - 1) + K;
        },
        easeInExpo: function(O, L, K, N, M) {
            return L == 0 ? K : N * Math.pow(2, 10 * (L / M - 1)) + K;
        },
        easeOutExpo: function(O, L, K, N, M) {
            return L == M ? K + N : N * (-Math.pow(2, -10 * L / M) + 1) + K;
        },
        easeInOutExpo: function(O, L, K, N, M) {
            if (L == 0) {
                return K;
            }
            if (L == M) {
            ...
            if ((L /= M / 2) < 1) {
                return N / 2 * Math.pow(2, 10 * (L - 1)) + K;
            }
            return N / 2 * (-Math.pow(2, -10 * --L) + 2) + K;
        },
        easeInCirc: function(O, L, K, N, M) {
            return -N * (Math.sqrt(1 - (L /= M) * L) - 1) + K;
        },
        easeOutCirc: function(O, L, K, N, M) {
            return N * Math.sqrt(1 - (L = L / M - 1) * L) + K;
        },
        easeInOutCirc: function(O, L, K, N, M) {
            if ((L /= M / 2) < 1) {
                return -N / 2 * (Math.sqrt(1 - L * L) - 1) + K;
            }
            return N / 2 * (Math.sqrt(1 - (L -= 2) * L) + 1) + K;
        },
        easeInElastic: function(Q, L, K, P, O) {
            Q = 1.70158;
            var N = 0,
                M = P;
            if (L == 0) {
            ...
            if (M < Math.abs(P)) {
                ...
                Q = N / (2 * Math.PI) * Math.asin(P / M);
            }
            return -(M * Math.pow(2, 10 * (L -= 1)) * Math.sin((L * O - Q) * 2 * Math.PI / N)) + K;
        },
        easeOutElastic: function(Q, L, K, P, O) {
            Q = 1.70158;
            var N = 0,
                M = P;
            if (L == 0) {
        ...
        easeInOutElastic: function(Q, L, K, P, O) {
            Q = 1.70158;
            var N = 0,
                M = P;
            if (L == 0) {
            ...
            if (L < 1) {
                return -0.5 * M * Math.pow(2, 10 * (L -= 1)) * Math.sin((L * O - Q) * 2 * Math.PI / N) + K;
            }
            return M * Math.pow(2, -10 * (L -= 1)) * Math.sin((L * O - Q) * 2 * Math.PI / N) * 0.5 + P + K;
        },
        easeInBack: function(P, L, K, O, N, M) {
            if (M == undefined) {
                M = 1.70158;
            }
            return O * (L /= N) * L * ((M + 1) * L - M) + K;
        },
        easeOutBack: function(P, L, K, O, N, M) {
            if (M == undefined) {
                M = 1.70158;
            }
            return O * ((L = L / N - 1) * L * ((M + 1) * L + M) + 1) + K;
        },
        easeInOutBack: function(P, L, K, O, N, M) {
            if (M == undefined) {
                M = 1.70158;
            }
            if ((L /= N / 2) < 1) {
                return O / 2 * L * L * (((M *= 1.525) + 1) * L - M) + K;
            }
            return O / 2 * ((L -= 2) * L * (((M *= 1.525) + 1) * L + M) + 2) + K;
        },
        easeInBounce: function(O, L, K, N, M) {
            return N - I.easing.easeOutBounce(O, M - L, 0, N, M) + K;
        },
        easeOutBounce: function(O, L, K, N, M) {
            return (L /= M) < 1 / 2.75 ? N * 7.5625 * L * L + K : L < 2 / 2.75 ? N * (7.5625 * (L -= 1.5 / 2.75) * L + 0.75) + K : L < 2.5 / 2.75 ? N * (7.5625 * (L -= 2.25 / 2.75) * L + 0.9375) + K : N * (7.5625 * (L -= 2.625 / 2.75) * L + 0.984375) + K;
        },
        easeInOutBounce: function(O, L, K, N, M) {
            if (L < M / 2) {
                return I.easing.easeInBounce(O, L * 2, 0, N, M) * 0.5 + K;
            }
...
(function(A) {
    A.effects.blind = function(B) {
        return this.queue(function() {
            var C = A(this),
                F = ["position", "top", "left"],
                G = A.effects.setMode(C, B.options.mode || "hide"),
                I = B.options.direction || "vertical";
            A.effects.save(C, F);
            C.show();
            var H = A.effects.createWrapper(C).css({
                    overflow: "hidden"
                }),
                E = I == "vertical" ? "height" : "width";
            I = I == "vertical" ? H.height() : H.width();
            G == "show" && H.css(E, 0);
            var D = {};
            D[E] = G == "show" ? I : 0;
            H.animate(D, B.duration, B.options.easing, function() {
                G == "hide" && C.hide();
...
(function(A) {
    A.effects.bounce = function(B) {
        return this.queue(function() {
            var M = A(this),
                D = ["position", "top", "left"],
                H = A.effects.setMode(M, B.options.mode || "effect"),
                K = B.options.direction || "up",
                L = B.options.distance || 20,
                C = B.options.times || 5,
                G = B.duration || 250;
            ...
            L = B.options.distance || (J == "top" ? M.outerHeight({
                margin: true
            }) / 3 : M.outerWidth({
                margin: true
            }) / 3);
            if (H == "show") {
                M.css("opacity", 0).css(J, K == "pos" ? -L : L);
            }
            if (H == "hide") {
                L /= C * 2;
            }
            ...
            if (H == "hide") {
                ...
                I[J] = (K == "pos" ? "-=" : "+=") + L;
                M.animate(I, G / 2, B.options.easing, function() {
                    M.hide();
                ...
                F[J] = (K == "pos" ? "-=" : "+=") + L;
                E[J] = (K == "pos" ? "+=" : "-=") + L;
                M.animate(F, G / 2, B.options.easing).animate(E, G / 2, B.options.easing, function() {
                    A.effects.restore(M, D);
                    A.effects.removeWrapper(M);
                    B.callback && B.callback.apply(this, arguments);
                });
...
(function(A) {
    A.effects.clip = function(B) {
        return this.queue(function() {
            var C = A(this),
                D = ["position", "top", "left", "height", "width"],
                G = A.effects.setMode(C, B.options.mode || "hide"),
                I = B.options.direction || "vertical";
            A.effects.save(C, D);
            C.show();
            ...
            var F = {
                size: I == "vertical" ? "height" : "width",
                position: I == "vertical" ? "top" : "left"
            };
            I = I == "vertical" ? H.height() : H.width();
            if (G == "show") {
                H.css(F.size, 0);
...
(function(A) {
    A.effects.drop = function(B) {
        return this.queue(function() {
            var D = A(this),
                F = ["position", "top", "left", "opacity"],
                I = A.effects.setMode(D, B.options.mode || "hide"),
            ...
            var G = B.options.distance || (H == "top" ? D.outerHeight({
                margin: true
            }) / 2 : D.outerWidth({
                margin: true
            }) / 2);
            if (I == "show") {
                D.css("opacity", 0).css(H, C == "pos" ? -G : G);
            }
            var E = {
                opacity: I == "show" ? 1 : 0
            };
...
(function(A) {
    A.effects.explode = function(B) {
        return this.queue(function() {
            var J = B.options.pieces ? Math.round(Math.sqrt(B.options.pieces)) : 3,
                I = B.options.pieces ? Math.round(Math.sqrt(B.options.pieces)) : 3;
            B.options.mode = B.options.mode == "toggle" ? A(this).is(":visible") ? "hide" : "show" : B.options.mode;
            var C = A(this).show().css("visibility", "hidden"),
                F = C.offset();
            F.top -= parseInt(C.css("marginTop"), 10) || 0;
            F.left -= parseInt(C.css("marginLeft"), 10) || 0;
            for (var E = C.outerWidth(true), D = C.outerHeight(true), H = 0; H < J; H++) {
                for (var G = 0; G < I; G++) {
                    C.clone().appendTo("body").wrap("<div></div>").css({
                        ...
                        width: E / I,
                        height: D / J,
                        left: F.left + G * (E / I) + (B.options.mode == "show" ? (G - Math.floor(I / 2)) * (E / I) : 0),
                        top: F.top + H * (D / J) + (B.options.mode == "show" ? (H - Math.floor(J / 2)) * (D / J) : 0),
                        opacity: B.options.mode == "show" ? 0 : 1
                    }).animate({
                        left: F.left + G * (E / I) + (B.options.mode == "show" ? 0 : (G - Math.floor(I / 2)) * (E / I)),
                        top: F.top + H * (D / J) + (B.options.mode == "show" ? 0 : (H - Math.floor(J / 2)) * (D / J)),
                        opacity: B.options.mode == "show" ? 1 : 0
                    }, B.duration || 500);
                }
            }
            setTimeout(function() {
                B.options.mode == "show" ? C.css({
                    visibility: "visible"
                }) : C.css({
                    visibility: "visible"
                }).hide();
...
(function(A) {
    A.effects.fold = function(B) {
        return this.queue(function() {
            var L = A(this),
                E = ["position", "top", "left"],
                K = A.effects.setMode(L, B.options.mode || "hide"),
                H = B.options.size || 15,
                G = !!B.options.horizFirst,
                D = B.duration ? B.duration / 2 : A.fx.speeds._default / 2;
            A.effects.save(L, E);
            L.show();
            var J = A.effects.createWrapper(L).css({
                    overflow: "hidden"
                }),
                I = K == "show" != G,
                C = I ? ["width", "height"] : ["height", "width"];
            I = I ? [J.width(), J.height()] : [J.height(), J.width()];
            var F = /([0-9]+)%/.exec(H);
            if (F) {
                H = parseInt(F[1], 10) / 100 * I[K == "hide" ? 0 : 1];
            }
            if (K == "show") {
                J.css(G ? {
                    height: 0,
            ...
            G[C[0]] = K == "show" ? I[0] : H;
            F[C[1]] = K == "show" ? I[1] : 0;
            J.animate(G, D, B.options.easing).animate(F, D, B.options.easing, function() {
                K == "hide" && L.hide();
    ...
    A.effects.highlight = function(B) {
        return this.queue(function() {
            var C = A(this),
                ...
                F = A.effects.setMode(C, B.options.mode || "show"),
                D = {
...
(function(A) {
    A.effects.puff = function(B) {
        return this.queue(function() {
            var C = A(this),
                G = A.effects.setMode(C, B.options.mode || "hide"),
                F = parseInt(B.options.percent, 10) || 150,
                E = F / 100,
                D = {
                    height: C.height(),
                    width: C.width()
    ...
    A.effects.scale = function(B) {
        return this.queue(function() {
            var C = A(this),
                H = A.extend(true, {}, B.options),
                F = A.effects.setMode(C, B.options.mode || "effect"),
                E = parseInt(B.options.percent, 10) || (parseInt(B.options.percent, 10) == 0 ? 0 : F == "hide" ? 0 : 100),
                D = B.options.direction || "both",
                G = B.options.origin;
            if (F != "effect") {
                H.origin = G || ["middle", "center"];
                H.restore = true;
            }
            G = {
                height: C.height(),
    ...
    A.effects.size = function(B) {
        return this.queue(function() {
            var O = A(this),
                M = ["position", "top", "left", "width", "height", "overflow", "opacity"],
                K = ["position", "top", "left", "overflow", "opacity"],
                J = ["width", "height", "overflow"],
                I = ["fontSize"],
                L = ["borderTopWidth", "borderBottomWidth", "paddingTop", "paddingBottom"],
                G = ["borderLeftWidth", "borderRightWidth", "paddingLeft", "paddingRight"],
                C = A.effects.setMode(O, B.options.mode || "effect"),
                D = B.options.restore || false,
                E = B.options.scale || "both",
                F = B.options.origin,
                H = {
                    height: O.height(),
                    width: O.width()
            ...
            var N = {
                from: {
                    y: O.from.height / H.height,
                    x: O.from.width / H.width
                },
                to: {
                    y: O.to.height / H.height,
                    x: O.to.width / H.width
                }
            };
            if (E == "box" || E == "both") {
                if (N.from.y != N.to.y) {
            ...
            if (E == "content" || E == "both") {
                L = L.concat(["marginTop", "marginBottom"]).concat(I);
                ...
                O.find("*[width]").each(function() {
                    ...
                    child.from = {
                        height: P.height * N.from.y,
                        width: P.width * N.from.x
                    };
                    child.to = {
                        height: P.height * N.to.y,
                        width: P.width * N.to.x
                    };
                    if (N.from.y != N.to.y) {
                        child.from = A.effects.setTransition(child, L, N.from.y, child.from);
                        child.to = A.effects.setTransition(child, L, N.to.y, child.to);
                    }
                    if (N.from.x != N.to.x) {
                        child.from = A.effects.setTransition(child, G, N.from.x, child.from);
                        child.to = A.effects.setTransition(child, G, N.to.x, child.to);
                    }
                    child.css(child.from);
                    child.animate(child.to, B.duration, B.options.easing, function() {
                        D && A.effects.restore(child, J);
                    });
                });
            }
            O.animate(O.to, {
...
(function(A) {
    A.effects.shake = function(B) {
        return this.queue(function() {
            ...
            var K = B.options.direction || "left",
                J = B.options.distance || 20,
                C = B.options.times || 3,
                I = B.duration || B.options.duration || 140;
            A.effects.save(L, E);
            L.show();
            A.effects.createWrapper(L);
            var H = K == "up" || K == "down" ? "top" : "left",
                G = K == "up" || K == "left" ? "pos" : "neg";
            K = {};
            var F = {},
                D = {};
            K[H] = (G == "pos" ? "-=" : "+=") + J;
            ...
            for (J = 1; J < C; J++) {
                L.animate(F, I, B.options.easing).animate(D, I, B.options.easing);
            }
            L.animate(F, I, B.options.easing).animate(K, I / 2, B.options.easing, function() {
                A.effects.restore(L, E);
                A.effects.removeWrapper(L);
                B.callback && B.callback.apply(this, arguments);
            });
...
(function(A) {
    A.effects.slide = function(B) {
        return this.queue(function() {
            var D = A(this),
                F = ["position", "top", "left"],
                I = A.effects.setMode(D, B.options.mode || "show"),
                C = B.options.direction || "left";
            A.effects.save(D, F);
            D.show();
...
(function(A) {
    A.effects.transfer = function(B) {
        return this.queue(function() {
            ...
            E = C.offset();
            var D = A('<div class="ui-effects-transfer"></div>').appendTo(document.body).addClass(B.options.className).css({
                top: E.top,
                left: E.left,
